      ...
      <div style={{ height: 130, width: 300 }}>
        ...
        >
          <Chart id={0} opacity={1} height={100} yExtents={d => [d.deposit]}>
            ...
            {/* <LineSeries strokeWidth={3} yAccessor={d => d.rewards} stroke="#1a42f9" />
            <LineSeries strokeWidth={3} yAccessor={d => d.deposit} stroke="#3e11a5" /> */}
...
export default fitWidth(StakingChartNew);
