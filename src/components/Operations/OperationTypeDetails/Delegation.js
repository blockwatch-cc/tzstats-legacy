...
const Delegation = ({ operation }) => {
  return (
    <>
      <FlexRowSpaceBetween>
        <Sender>
          <HashedBox hash={operation.sender.address} typeName={'Delegator'} />
        </Sender>
        ...
        <Receiver>
          <HashedBox hash={operation.receiver.address} typeName={'Delegate'} />
        </Receiver>
      </FlexRowSpaceBetween>
      <FlexRowSpaceBetween>
        ...
        <FlexRowSpaceBetween flexBasis={185}>
          <DataBox
            title="Balance"
            valueSize="14px"
            value={operation.receiver.total_balance}
