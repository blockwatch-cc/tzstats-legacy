...
function getOperationsSettings(block) {
  return [
    ...
    { color: "rgb(198, 219, 239)", value: block.n_activation, id: `Activations - ${formatValue(block.n_activation)}` },
    { color: "rgb(158, 202, 225)", value: block.n_seed_nonce, id: `Seed Nonces - ${formatValue(block.n_seed_nonce)}` },
    { color: "rgb(107, 174, 214)", value: block.n_double_baking, id: `2x Baking - ${formatValue(block.n_double_baking)}` },
    { color: "rgb(66, 146, 198)", value: block.n_double_endorsement, id: `2x Endoresment - ${formatValue(block.n_double_endorsement)}` },
    { color: "rgb(33, 113, 181)", value: block.n_reveal, id: `Reveals - ${formatValue(block.n_reveal)}` },
    { color: "rgb(8, 81, 156)", value: block.n_origination, id: `Originations - ${formatValue(block.n_origination)}` },
    { color: "rgb(8, 48, 107)", value: block.n_proposal, id: `Proposals - ${formatValue(block.n_proposal)}` },
    { color: "rgb(94, 79, 162)", value: block.n_ballot, id: `Ballots - ${formatValue(block.n_ballot)}` },
  ];
}
