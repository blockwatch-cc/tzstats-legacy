...
const TxTypeIcon = ({ type, fontSize = 14, isSuccess, mr }) => {
  ...
  switch (type) {
    ...
    case 'delegation':
      return (
        <Icon fontSize={fontSize} color={color} mr={mr}>
          <svg width={fontSize} height={fontSize} viewBox="0 0 32 32" version="1.1" >
            <g stroke="none" fill="none" >
              <path d="M12.1353635,28.5378895 L25.5688165,15.9999926 L12.1353635,3.46211054 C11.3278621,2.70844261 11.2842215,1.44286485 12.0378895,0.635363499 C12.7915574,-0.172137853 14.0571351,-0.215778465 14.8646365,0.537889464 L31.4311835,15.9999926 L14.8646365,31.4621105 C14.0571351,32.2157785 12.7915574,32.1721379 12.0378895,31.3646365 C11.2842215,30.5571351 11.3278621,29.2915574 12.1353635,28.5378895 Z M2,8 C2,6.8954305 2.8954305,6 4,6 C5.1045695,6 6,6.8954305 6,8 L6,24 C6,25.1045695 5.1045695,26 4,26 C2.8954305,26 2,25.1045695 2,24 L2,8 Z" fill={color}></path>
            </g>
          </svg>
        </Icon>
      );
    case 'double_baking_evidence':
      return (
        <Icon fontSize={fontSize} fontDiff={fontSize} color={color} mr={mr}>
          &#8782;
        </Icon>
      );
