...
export const BLOCKWATCH_URL = process.env.REACT_APP_BLOCKWATCH_API_URL || '<[BLOCKWATCH_API_URL]>';
...
export const TZSTATS_URL = process.env.REACT_APP_TZSTATS_API_URL || '<[TZSTATS_API_URL]>';
