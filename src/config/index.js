...
export const BLOCKWATCH_URL = process.env.BLOCKWATCH_API_URL || 'https://cors-anywhere.herokuapp.com/https://data.blockwatch.cc/v1/';
...
export const TZSTATS_URL = process.env.TZSTATS_API_URL || 'https://cors-anywhere.herokuapp.com/https://api.tzstats.com';
