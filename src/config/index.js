...
export const BLOCKWATCH_URL = 'https://cors-anywhere.herokuapp.com/https://data.blockwatch.cc/v1/';
...
export const TZSTATS_URL = 'https://cors-anywhere.herokuapp.com/https://api.tzstats.com';
